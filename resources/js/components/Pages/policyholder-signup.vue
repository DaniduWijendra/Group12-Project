        ...
        <v-flex xs12 sm12 md12 lg12 >
                        ...
                        <v-row>
                            <!-- sign up via social media -->
                                <v-col cols="12" sm="12" md="12" >
                                           <v-btn x-large color="primary" dark> <v-icon dark left>facebook</v-icon> Sign Up with FaceBook </v-btn>
                                </v-col>
                                <v-col cols="12" sm="12" md="12" >
                                       <v-btn  x-large color="white" class="grey--text" dark> <v-icon color="green darken-1" dark left>mdi-google</v-icon> Sign Up with FaceBook </v-btn>                                        </v-col>
                                        <v-col cols="12" sm="12" md="12" >
                                           <v-btn  x-large color="white" class="grey--text" dark> <v-icon color="black darken-1" dark left>mdi-apple</v-icon> Sign Up with FaceBook </v-btn>
                                        </v-col>
          ...
          >
            ...
            ></v-date-picker>
                                         ...
                                         <v-col cols="12" sm="4" md="4" >
                                           <v-text-field type="number" prepend-icon="mdi-phone" class="inputPrice"  v-model="contact" :rules="[rules.required,rules.tel]" label="Contact" maxlength="10" required></v-text-field>
                                        </v-col>
                                        ...
                                        <v-col cols="12" sm="4" md="4" >
                                         ...
                                         <v-text-field prepend-icon="mdi-card-account-details-star" v-model="nic" :rules="[rules.required,rules.nic]" label="NIC number" maxlength="10" required></v-text-field>
...
export default {
  ...
  data: () => ({
    ...
    rules: {
      ...
      nic: v => (v && v.length === 10) || "NIC number not valid"
    },
    genderrules: {
      required: value => !!value || "Required.",
    },
